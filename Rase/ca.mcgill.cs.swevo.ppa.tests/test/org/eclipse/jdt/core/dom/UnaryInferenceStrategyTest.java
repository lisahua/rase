...
public class UnaryInferenceStrategyTest {
	...
	public void testUnary() {
		...
		name = cu1Visitor.getNames().get("c").get(0);
		assertNotNull(name.resolveBinding());
		...
		name = cu1Visitor.getNames().get("d").get(0);
		assertNotNull(name.resolveBinding());
		assertEquals("boolean", name.resolveTypeBinding().getQualifiedName());
		...
		name = cu1Visitor.getNames().get("e").get(0);
		assertNotNull(name.resolveBinding());
		assertEquals("int", name.resolveTypeBinding().getQualifiedName());
		...
		name = cu1Visitor.getNames().get("f").get(0);
		assertNotNull(name.resolveBinding());
		assertEquals("int", name.resolveTypeBinding().getQualifiedName());
		...
		name = cu1Visitor.getNames().get("h").get(0);
		assertNotNull(name.resolveBinding());
		assertEquals("int", name.resolveTypeBinding().getQualifiedName());
		...
		name = cu1Visitor.getNames().get("i").get(0);
		assertNotNull(name.resolveBinding());
		assertEquals("int", name.resolveTypeBinding().getQualifiedName());
		...
		name = cu1Visitor.getNames().get("j").get(0);
		assertNotNull(name.resolveBinding());
		assertEquals("int", name.resolveTypeBinding().getQualifiedName());
	...
	@Test
	public void testFQNUnary() {
		Name name = cu1Visitor.getNames().get("z").get(0);
		assertNotNull(name.resolveBinding());
		assertEquals("int", name.resolveTypeBinding().getQualifiedName());
