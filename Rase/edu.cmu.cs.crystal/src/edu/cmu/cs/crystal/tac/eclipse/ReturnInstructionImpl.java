 ...
 * @since 3.3.2
 */
public class ReturnInstructionImpl extends
		AbstractTACInstruction<ReturnStatement> implements ReturnInstruction {

	/**
	 * Creates a return instruction for the given return statement, which must
	 * return a value.
	 * 
	 * @param node
	 *            Return statement with non-<code>null</code> expression.
	 * @param tac
	 */
	public ReturnInstructionImpl(ReturnStatement node, IEclipseVariableQuery tac) {
		...
		// throw new
		// IllegalArgumentException("Explicit return instructions only for actual values.");
	}
	...
	public String toString() {
		return "return " + getReturnedVariable();
	}
